...
const SidePanel: React.FC = () => {
  ...
  const handleSendMessage = () => {
    ...
    // Simulate or make an API call for the response
    setTimeout(() => {
      // In future, this would be replaced with an actual API call
      const assistantResponse: Message = {
        id: `assistant-${Date.now()}`,
        role: "assistant",
        content: `I received your message: "${newUserMessage.content}". This is a placeholder response until the backend is integrated.`,
        timestamp: new Date(),
      };
