  ...
  const handleWindowSizeChange = async (newSize: WindowSize['size']) => {
    try {
      ...
      if (newSize === 'compact') {
        ...
        // Use the global window object to close
        self.close();
      } else if (newSize === 'medium' && currentWindow.id) {
        if (chrome.sidePanel) {
          ...
          <div className={`section ${activeSection === 'settings' ? 'active' : ''}`} id="settings">
            <div className="settings-container">
              <div className="settings-header">
                ...
                <p>Customize your Cobra experience with these settings.</p>
              </div>
              ...
              <div className="settings-section">
                ...
                <div className="setting-item">
                  ...
                  <div className="toggle-switch" onClick={handleAnimationsToggle}>
              ...
              <div className="settings-section">
                ...
                <div className="setting-item">
                  ...
                  <p className="setting-description">
                    Test button will request browser notification permissions and play your selected timer sound.
                  </p>
                  </div>
